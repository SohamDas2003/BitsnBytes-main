 ...
 * Clean, modern digital marketing agency profile for MARCUS EGGER LLC.
 */
...
export const SITE_CONFIG = {
  // Brand Identity
  brand: {
    name: "MARCUS EGGER LLC",
    legalName: "MARCUS EGGER LLC",
    domain: "marcusegger.com",
    websiteUrl: "https://marcusegger.com",
  ...
  contact: {
    email: {
      primary: "hello@marcusegger.com",
      support: "support@marcusegger.com",
      careers: "careers@marcusegger.com",
      sales: "sales@marcusegger.com",
    },
    workingHours: {
    ...
    address: "323 S INDIAN CANYON DR PALM SPRINGS, CA 92262",
  ...
  socials: {
    linkedin: {
      url: "https://linkedin.com/company/bits-n-bytes-digital",
      handle: "@bits-n-bytes-digital",
      label: "LinkedIn",
    },
    twitter: {
      url: "https://x.com/bitsnbytes_digi",
      handle: "@bitsnbytes_digi",
      label: "X (Twitter)",
    },
    instagram: {
      url: "https://instagram.com/bitsnbytesdigital",
      handle: "@bitsnbytesdigital",
      label: "Instagram",
    },
    youtube: {
      url: "https://youtube.com/@bitsnbytesdigital",
      handle: "@bitsnbytesdigital",
      label: "YouTube",
    },
  },
  ...
  caseStudies: [
    {
      ...
      testimonial: {
        quote: "MARCUS EGGER LLC completely transformed our marketing. Our revenue more than tripled and our customer acquisition cost dropped significantly.",
  ...
  testimonials: [
    {
      id: "1",
      quote: "Working with MARCUS EGGER LLC has been an absolute game-changer. They don't just generate vanity clicks—they deliver real, bottom-line revenue growth and treat our budget like their own.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Simply reach out via our contact form below or email us directly at hello@marcusegger.com. We'll schedule a complimentary 30-minute discovery call to discuss your goals and review your current marketing.",
      category: "process",
    },
  ] as FaqItem[],
